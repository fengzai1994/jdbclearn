...
public class BaseDAO {
     ...
     * 封装的过程：
     * 1.返回的类型：泛型：类型不确定，调用者知道，调用时，将此次查询的结果类型告知BaseDAO就可以了。T Double
    ...
    /**
     * 通用查询：在上面查询的结果中获取第一个结果。简化了获取单行单列的获取，单行多列的获取
     */
